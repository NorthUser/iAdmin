...
class PermissionsControllerTest < ActionController::TestCase
  ...
  test "should create permission" do
    assert_difference('Permission.count') do
      post :create, permission: { action: @permission.action, controller: @permission.controller, description: @permission.description, key: @permission.key }
    end
  ...
  test "should update permission" do
    put :update, id: @permission, permission: { action: @permission.action, controller: @permission.controller, description: @permission.description, key: @permission.key }
    assert_redirected_to permission_path(assigns(:permission))
  end
