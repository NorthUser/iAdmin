...
class PersonTypesControllerTest < ActionController::TestCase
  ...
  test "should create person_type" do
    assert_difference('PersonType.count') do
      post :create, person_type: { category: @person_type.category, public: @person_type.public, role: @person_type.role }
    end
  ...
  test "should update person_type" do
    put :update, id: @person_type, person_type: { category: @person_type.category, public: @person_type.public, role: @person_type.role }
    assert_redirected_to person_type_path(assigns(:person_type))
  end
